...
import type { RecordItem } from "."; // from news index
...
export default function NewsTable({
    ...
    const exportCSV = () => {
        const cols: (keyof RecordItem)[] = ["id", "title", "status", "order", "author", "date", "itemsCount", "firstItemTitle"];
                        ...
                        <TableBody>
                            {current.map((r, i) => (
                                ...
                                >
                                    ...
                                    {visibleCols.firstItemTitle && <TableCell>{r.firstItemTitle || <span className="text-neutral-400">—</span>}</TableCell>}
