// app/(admin)/partners-reviews/table.tsx
"use client";
...
import type { RecordItem } from "."; // from partners-reviews index
...
export default function PartnersReviewsTable({
    rows,
    onEdit,
    onDelete,
    onCreate,
    ...
    >({
        ...
        author: true,
        date: true,
        imageCol: true, // show first item image as thumbnail
        actions: true,
        // hidden from sorting UI (these exist on RecordItem but are not shown)
        id: false,
        coverImage: false,
    });
    ...
    const filtered = useMemo(() => {
        let out =
            rows?.filter((r) =>
                [r.id, r.title, r.author, String(r.itemsCount ?? ""), r.date]
                    .join(" ")
                    .toLowerCase()
        ...
        out.sort((a, b) => {
            ...
            // title/author/status default string compare
    ...
    const exportCSV = () => {
        const cols: (keyof RecordItem)[] = ["id", "title", "status", "itemsCount", "author", "date"];
        ...
        a.href = url;
        a.download = "partners-reviews.csv";
        a.click();
            ...
            <CardContent className="space-y-4 p-4 md:p-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        <h2 className="text-lg font-semibold">Partners Reviews</h2>
                        <Select
                        ...
                        <TableBody>
                            {current.map((r, i) => (
                                ...
                                >
                                    ...
                                    {visibleCols.itemsCount && <TableCell>{r.itemsCount}</TableCell>}
