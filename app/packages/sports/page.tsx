...
const fallbackFeatured = {
  id: "1",
  title: "Somali National Team Wins Regional Football Championship",
  excerpt:
    "Historic victory brings pride to Somali sports fans as the national team secures the regional cup in a thrilling final.",
  image: PLACEHOLDER,
  category: "Football",
  author: "Sports Desk",
  date: "2024-04-01",
...
const fallbackArticles = [
  {
    id: "2",
    title: "Youth Basketball League Expands to New Cities",
    excerpt:
      "The popular youth basketball league now includes teams from five new cities, boosting local sports engagement.",
    image: PLACEHOLDER,
    category: "Basketball",
    author: "Amina Yusuf",
    date: "2024-03-28",
  ...
  {
    id: "3",
    title: "Somali Runners Shine at International Marathon",
    excerpt: "Athletes from Somalia set new records and inspire at the annual international marathon event.",
    image: PLACEHOLDER,
    category: "Athletics",
  ...
  {
    id: "4",
    title: "Community Sports Centers Open Across Mogadishu",
    excerpt: "New facilities provide training and recreation for youth and adults in the capital.",
    image: PLACEHOLDER,
    category: "Community",
    author: "Fatima Abdi",
    date: "2024-03-15",
  ...
  {
    id: "5",
    title: "Somali Women’s Volleyball Team Makes History",
    excerpt:
      "The national women’s volleyball team qualifies for continental championships for the first time.",
    image: PLACEHOLDER,
    category: "Volleyball",
    author: "Ahmed Ali",
    date: "2024-03-10",
  ...
  {
    id: "6",
    title: "Sports Festival Unites Communities in Hargeisa",
    excerpt:
      "Annual sports festival brings together athletes and fans from across Somaliland for a week of competition and celebration.",
    image: PLACEHOLDER,
    category: "Festival",
  ...
  {
    id: "7",
    title: "New Stadium Opens with State-of-Art Facilities",
    excerpt: "Modern stadium enhances sports infrastructure and hosts major events.",
    image: PLACEHOLDER,
...
// null/invalid → placeholder; relative → prefix base
  ...
  if (
    ...
    return {
      description:
        ...
        "Discover the latest sports news, achievements, and events from across Somalia and East Africa",
      stories,
    };
  }
...
export default function SportsPage() {
  ...
  // Fetch DB for slug=sports
  const { data, isLoading, isError } = useGetPackagesQuery({ slug: "sports" });
  const item: DbItem | null = data?.data?.find((d: DbItem) => d.slug === "sports") ?? null;
